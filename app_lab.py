                ...
                for acc_id, creds in accounts.items():
                    try:
                        with st.spinner(f"Auth {acc_id}..."):
                            # Logic from your sensor_catchup.py

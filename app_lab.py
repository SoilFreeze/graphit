    ...
    with tab1:
        ...
        if u_file is not None:
            try:
                ...
                # --- TYPE 1: MASTER LOG (Narrow format) ---
                ...
                # --- TYPE 2: LORD / SENSORCONNECT (Wide format) ---
                ...
                # --- TYPE 3: SENSORPUSH EXPORT (Narrow format with header info) ---
                ...
                if not df_up.empty:
                    ...
                    st.write(f"Parsed {len(df_up)} data points. Preview:")

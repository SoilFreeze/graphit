...
def build_high_speed_graph(df, title, start_view, end_view, active_refs, unit_mode, unit_label, 
    ...
    - Removed: All Theoretical Curve and dynamic shift logic.
    ...
    - Red 'Now' Line: Simple dashed line (no text to prevent TypeError).
    """
    import plotly.graph_objects as go
    ...
    # 2. SENSOR DATA (15-Color Palette)
    sf_15_palette = [
    ...
    # 3. REFERENCE LINES
    # Medium Blue Dashed Freeze Line (RoyalBlue)
    fig.add_hline(
        y=freeze_pt, 
        line_width=2, 
        line_dash="dash", 
    ...
    # Red "NOW" Line (Line only, no text annotation to prevent crashes)
